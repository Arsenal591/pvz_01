...
{
	"../pvz-material/images/bullets/green.gif",
	"../pvz-material/images/bullets/fire.gif",
	"../pvz-material/images/bullets/ice.gif"
};

const QString SHOVEL_PATH = "../pvz-material/images/interface/Shovel.png";
...
const QString PICKCARD_BUTTON_PATH = "../pvz-material/button/ShovelBack.png";
...
const QString BUTTONCLICK_AUDIO_PATH = "../pvz-material/audio/buttonclick.mp3";
